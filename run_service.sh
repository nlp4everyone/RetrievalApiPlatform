...
sudo docker compose --env-file .env -f docker/compose_db.yml -f docker/compose_serving.yml -f docker/compose_web.yml -f docker/compose_tracking.yml up --build -d --remove-orphans
